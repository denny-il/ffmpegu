...
import { FFmpegCommand } from "../../src/command.js";
...
describe("FFmpegCommand", () => {
	describe("constructor", () => {
		...
		it("should create command with provided options", () => {
			...
			const command = new FFmpegCommand(options);
	...
	describe("usesStdin", () => {
		it("should return false for string input", () => {
			const command = new FFmpegCommand({ input: "input.mp4" });
		...
		it("should return true for stream input", () => {
			const mockStream = { pipe: () => {} };
			const command = new FFmpegCommand({ input: mockStream as any });
	...
	describe("usesStdout", () => {
		it("should return false for string output", () => {
			const command = new FFmpegCommand({ output: "output.mp4" });
		...
		it("should return true for stream output", () => {
			const mockStream = { write: () => {} };
			const command = new FFmpegCommand({ output: mockStream as any });
